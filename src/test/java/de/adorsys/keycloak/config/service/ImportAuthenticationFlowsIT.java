...
class ImportAuthenticationFlowsIT extends AbstractImportIT {
    ...
    void shouldFailWhenTryAddFlowWithDefectiveExecutionFlow() throws IOException {
        var foundImport = getFirstImport("05_try_to_update_realm__add_flow_with_defective_execution_flow.json");
    ...
    void shouldFailWhenTryToUpdateDefectiveFlowRequirementWithExecutionFlow() throws IOException {
        var foundImport = getFirstImport("06_try_to_update_realm__change_requirement_in_defective_flow_with_execution_flow.json");
    ...
    void shouldFailWhenTryToUpdateFlowRequirementWithExecutionFlowWithNotExistingExecution() throws IOException {
        var foundImport = getFirstImport("07_try_to_update_realm__change_requirement_flow_with_execution_flow_with_not_existing_execution.json");
    ...
    void shouldFailWhenTryToUpdateFlowRequirementWithExecutionFlowWithDefectiveExecution() throws IOException {
        var foundImport = getFirstImport("08_try_to_update_realm__change_requirement_flow_with_execution_flow_with_defective_execution.json");
    ...
    void shouldFailWhenTryToUpdateFlowRequirementWithDefectiveExecutionFlow() throws IOException {
        var foundImport = getFirstImport("09_try_to_update_realm__change_requirement_flow_with_defective_execution_flow.json");
    ...
    void shouldNotUpdateSubFlowWithPseudoId() throws IOException {
        var foundImport = getFirstImport("27_update_realm__try-to-update-non-top-level-flow-with-pseudo-id.json");
    ...
    void shouldNotUpdateInvalidTopLevelFlow() throws IOException {
        var foundImport = getFirstImport("29_update_realm__try-to-update-invalid-top-level-flow.json");
    ...
    void shouldFailWhenTryingToUpdateBuiltInFlow() throws IOException {
        var foundImport = getFirstImport("40_update_realm__try-to-update-built-in-flow.json");
    ...
    void shouldFailWhenTryingToUpdateWithNonExistingFlow() throws IOException {
        var foundImport = getFirstImport("41_update_realm__try-to-update-with-non-existing-flow.json");
    ...
    void shouldUpdateSubBuiltinFLow() throws IOException {
        ...
        if (VersionUtil.ge(KeycloakExtension.KEYCLOAK_VERSION, "11")) {
    ...
    void shouldNotUpdateFlowWithBuiltInFalse() throws IOException {
        var foundImport = getFirstImport("44_update_realm__try-to-update-flow-set-builtin-false.json");
    ...
    void shouldNotUpdateFlowWithBuiltInTrue() throws IOException {
        var foundImport = getFirstImport("45_update_realm__try-to-update-flow-set-builtin-true.json");
    ...
    void shouldNotCreateBuiltInFlow() throws IOException {
        var foundImport = getFirstImport("46_update_realm__try-to-create-builtin-flow.json");
    ...
    void shouldNotUpdateFlowWithAuthenticatorOnBasicFlow() throws IOException {
        var foundImport = getFirstImport("63_update-realm__try-to-set-authenticator-basic-flow.json");
