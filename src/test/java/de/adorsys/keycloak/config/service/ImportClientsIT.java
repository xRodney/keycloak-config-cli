...
class ImportClientsIT extends AbstractImportIT {
    ...
    void shouldUpdateRealmRaiseErrorAddAuthorizationInvalidClient() throws IOException {
        ...
        /*
        var foundImport3 = getFirstImport("10.3_update_realm__raise_error_update_authorization_client_bearer_only.json");
        ...
        var foundImport4 = getFirstImport("10.4.2_update_realm__raise_error_update_authorization_client_public.json");
        ...
        var foundImport5 = getFirstImport("10.5_update_realm__raise_error_update_authorization_without_service_account_enabled.json");
        thrown = assertThrows(ImportProcessingException.class, () -> doImport(foundImport5));
    ...
    void shouldNotTriggerErrorWhenReferencingInvalidUuidInFineGrainedAuthz() throws IOException {
        ...
        var foundImport0 = getFirstImport("50.0_update_realm_update_authz_policy_for_unknown_type_with_id_realm-management.json");
        assertDoesNotThrow(() -> doImport(foundImport0));

        var foundImport1 = getFirstImport("50.1_update_realm_update_authz_policy_for_client_with_bad_id_realm-management.json");
        assertDoesNotThrow(() -> doImport(foundImport1));

        var foundImport2 = getFirstImport("50.2_update_realm_update_authz_policy_for_idp_with_bad_id_realm-management.json");
        assertDoesNotThrow(() -> doImport(foundImport2));

        var foundImport3 = getFirstImport("50.3_update_realm_update_authz_policy_for_role_with_bad_id_realm-management.json");
        assertDoesNotThrow(() -> doImport(foundImport3));

        var foundImport4 = getFirstImport("50.4_update_realm_update_authz_policy_for_group_with_bad_id_realm-management.json");
        assertDoesNotThrow(() -> doImport(foundImport4));
    }
